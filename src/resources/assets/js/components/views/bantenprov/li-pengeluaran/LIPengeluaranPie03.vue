...
export default {
  ...
  mounted: function () {
    axios.get('/json/bantenprov/li-pengeluaran/li-pengeluaran-pie-030.json').then(response => {
      ...
      this.pie.title.text =   res[0].xAxis.region + ' ' +res[0].xAxis.yyyy ;
      ...
      setInterval(() => {
        ...
        this.pie.title.text =   res[i].xAxis.region +' ' +res[i].xAxis.yyyy  ;
