...
export default {
  ...
  mounted: function () {
    axios.get('/json/bantenprov/li-pengeluaran/li-pengeluaran-010.json').then(response => {
      ...
      this.bar.title.text = res[0].xAxis.name+' (%)' ;
      ...
      setInterval(() => {
        ...
        this.bar.title.text =   res[i].xAxis.name+' (%)'  ;
